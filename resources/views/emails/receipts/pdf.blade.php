...
<body>
    <div class="bdwrapper">
        <table class="table">
            ...
            <tr>
                <td style="width:50%; text-align: start; border-top:1px solid #d3d0d0; border-bottom:1px solid #d3d0d0;">
                    <table style="width: 100%;border-collapse: collapse;">
                        <tbody>
                            <tr>
                                <td class="FtG" style="padding: 8px 10px 0 10px; text-align: end; font-size: 14px;">માનવ સેવા ચેરીટેબલ ટ્રસ્ટ સંચાલિત</td>
                            </tr>
                            <tr>
                                <td style="padding: 0px 10px 8px 10px; text-align: center;">
                                    <img src="{{ $pdfImages['logo'] ?? '' }}" style="max-width: 150px; height: auto;">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                <td class="FtG" style="width:50%; font-size: 14px; text-align: center; padding:8px 10px;border-top:1px solid #d3d0d0; border-bottom:1px solid #d3d0d0;border-left:1px solid #e7e7e7" colspan="2">
                    પીપળીયા ભવન, સ્વામિનારાયણ ગુરુકુળ સામે, <br>
                    ગોંડલ રોડ, ફાટક પાસે, ઓવરબ્રીઝ નીચે, <br>
                    ડી-માર્ટ વાળી શેરી, રાજકોટ મો. 85301 38001
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="padding-left:10px;padding-right:10px; width: 100%; padding-top: 4px;">
                    <table class="verticalalignTop" style="width: 100%;">
                        <tr>
                            <td style="width:100%; text-align: left; line-height: 1.5; word-break: break-word; overflow-wrap: anywhere;">
                                <span class="FtG" style="font-size: 14px;">સરનામું&nbsp;:&nbsp;</span>
                                <span style="font-size: 14px; border-bottom: 2px dotted #304C46; padding-bottom: 1px;">
            ...
            <tr>
                <td style="padding-top:12px;padding-bottom:12px;padding-left:10px;padding-right:10px; width: 45%;">
                    <table style="width:100%;border:1px solid #304C46;border-collapse:collapse;">
                        <tr>
                            <td style="padding:5px 8px; width: 40px; background:#216B46;color: #fff; font-size: 20px;">₹</td>
                            <td style="padding: 5px 8px; font-size: 18px; width: 100%;text-align: center;">{{ $order->total_amount  ?? '' }} /-</td>
                        </tr>
                        <tr>
                            <td colspan="2"class="FtG" style="font-size: 11px;background: #216b46;color: #fff; text-align: center;">તમોએ આપેલું દાન ઇન્કમટૅક્સ ની કલમ ૮૦ જી (૫) નીચે કરમુક્ત છે </td>
                        </tr>
                    </table>
                </td>
                <td style="padding-top:12px;padding-bottom:12px; width: 55%; padding-right: 10px;">
                     <table style="width:100%;border-collapse:collapse; margin-left: auto; text-align: center;">
                        <tr>
                            <td style="color:#8aa73c;font-weight: 600;" class="FtG">નાણા સ્વીકારનારની સહી</td>
                        </tr>
                        <tr>
                            <td><img src="{{ $pdfSignatureData }}" style="max-width: 100%; height: 60px;"></td>
                        </tr>
                        <tr>
                            <td style="color:#216b46;font-weight: 600;" class="FtG">માનવ સેવા ચેરીટેબલ ટ્રસ્ટ સંચાલિત</td>
                        </tr>
                     </table>
                </td>
            </tr>
            <tr>
                <td colspan="2" class="FtG" style="background:#304C46; color: #fff; font-size: 11px; padding:8px 10px;padding-right:1px;text-align: center;">આપના તરફથી મળેલ દાન બદલ અમો આપનો હૃદય પૂર્વક આભાર માનીએ છીએ. સાથો સાથ પરમ કૃપાળુ પરમાત્મા આપનો તથા આપણા પરિવારને સુ:ખ શાંતિ સમૃધ્ધિ આર્પે તેવી પ્રાર્થના...</td>
            </tr>
            <tr>
                <td colspan="2" style="padding: 0;">
                    <table style="width: 100%;border-collapse:collapse;">
                        <tbody>
                            <tr>
                                <td style="width:20%; padding: 0;"><img src="{{ $pdfImages['photo1'] ?? '' }}" style="width: 100%; height: 100px; object-fit: cover;"></td>
                                <td style="width:20%; padding: 0;"><img src="{{ $pdfImages['photo2'] ?? '' }}" style="width: 100%; height: 100px; object-fit: cover;"></td>
                                <td style="width:20%; padding: 0;"><img src="{{ $pdfImages['photo3'] ?? '' }}" style="width: 100%; height: 100px; object-fit: cover;"></td>
                                <td style="width:20%; padding: 0;"><img src="{{ $pdfImages['photo4'] ?? '' }}" style="width: 100%; height: 100px; object-fit: cover;"></td>
                                <td style="width:20%; padding: 0;"><img src="{{ $pdfImages['photo5'] ?? '' }}" style="width: 100%; height: 100px; object-fit: cover;"></td>
                            </tr>
                            <tr>
