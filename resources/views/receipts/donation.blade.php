@php
    $pdfFontSource = isset($pdfFontPath)
        ? 'file:///' . str_replace('\\', '/', $pdfFontPath)
        : asset('fonts/NotoSansGujarati-Regular.ttf');
    $signatureImageSource = isset($pdfSignaturePath)
...
<head>
  ...
  <style>
    @font-face {
        ...
        font-style: normal;
        font-weight: 400;
        src: url('{{ $pdfFontSource }}') format('truetype');
    }
    body{background: #eaefdc;}
    *{
        font-family: "Noto Sans Gujarati", DejaVu Sans, sans-serif !important;
        margin: 0;
        padding: 0;
                ...
                <td colspan="2" style="padding-left:10px;padding-right:10px; width: 100%; padding-top: 4px;">
                    <table class="verticalalignTop" style="width: 100%;">
                        <tr>
                            ...
                            <td style="width:100%; border-bottom: 2px dotted #304C46;">&nbsp;&nbsp; {{ $amountInWords ?? \App\Helpers\NumberHelper::amountInWords($order->total_amount) }} /-</td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding-top:18px;padding-bottom:18px;padding-left:10px;padding-right:10px;">
                    <table style="width:300px;border:1px solid #304C46;border-collapse:collapse;">
                        <tr>
                            ...
                            <td style="padding: 6px 12px; font-size: 22px; width: 100%;text-align: center;">{{ \App\Helpers\NumberHelper::formatWholeAmount($order->total_amount ?? 0) }} /-</td>
                        </tr>
                        <tr>
                ...
                <td style="padding-top:18px;padding-bottom:18px;">
                     <table style="width:240px;border-collapse:collapse; margin-left: auto; text-align: center;">
                        ...
                        <tr>
                            <td><img src="{{ $signatureImageSource }}" style="max-width: 100%; height: 80px;"></td>
                        </tr>
                        <tr>
